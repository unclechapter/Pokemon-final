...
public class SkinGenerator {
	public static Skin generateSkin(AssetManager assetManager) {
		...
		TextureAtlas uiAtlas = assetManager.get("res/packed/ui/uipack.atlas");
		...
		FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Gdx.files.internal("res/unpacked/font/pkmnrsi.ttf"));
		...
		BitmapFont smallFont = assetManager.get("res/unpacked/font/small_letters_font.fnt", BitmapFont.class);
