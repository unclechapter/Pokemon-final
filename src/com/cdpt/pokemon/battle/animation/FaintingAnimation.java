...
public class FaintingAnimation extends BattleAnimation {
	...
	public void initialize(AssetManager assetManager, TweenManager tweenManager) {
		...
		Tween.to(this, BattleAnimationAccessor.PRIMARY_OFFSET_Y, 0.3f).target(-0.5f).start(tweenManager);
		Tween.to(this, BattleAnimationAccessor.PRIMARY_ALPHA, 0.3f).target(0f).start(tweenManager);
	}
